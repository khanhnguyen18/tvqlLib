...
namespace Quanlythuvien {
    ...
    public class dtSachTra : DataSet {
        ...
        private DataRelation relationMUONSACHTRASACH;
        
        private DataRelation relationDOCGIAMUONSACH;
        
        private DataRelation relationQUYENSACHTRASACH;
        ...
        protected dtSachTra(SerializationInfo info, StreamingContext context) {
            ...
            if ((strSchema != null)) {
                ...
                if ((ds.Tables["TRASACH"] != null)) {
                    this.Tables.Add(new TRASACHDataTable(ds.Tables["TRASACH"]));
                }
        ...
        internal void InitVars() {
            ...
            this.tableTRASACH = ((TRASACHDataTable)(this.Tables["TRASACH"]));
        ...
        private void InitClass() {
            ...
            this.Tables.Add(this.tableTRASACH);
            ...
            fkc = new ForeignKeyConstraint("MUONSACHTRASACH", new DataColumn[] {
            ...
            fkc.DeleteRule = System.Data.Rule.Cascade;
            fkc.UpdateRule = System.Data.Rule.Cascade;
            fkc = new ForeignKeyConstraint("QUYENSACHTRASACH", new DataColumn[] {
            ...
            fkc.DeleteRule = System.Data.Rule.Cascade;
            fkc.UpdateRule = System.Data.Rule.Cascade;
            this.relationMUONSACHTRASACH = new DataRelation("MUONSACHTRASACH", new DataColumn[] {
                        this.tableMUONSACH.SOPHIEUMUONColumn}, new DataColumn[] {
            ...
            this.relationQUYENSACHTRASACH = new DataRelation("QUYENSACHTRASACH", new DataColumn[] {
                        this.tableQUYENSACH.MSSACHColumn}, new DataColumn[] {
        ...
        public class MUONSACHDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("dtSachTraKey1", new DataColumn[] {
        ...
        public class MUONSACHRow : DataRow {
            ...
            public TRASACHRow[] GetTRASACHRows() {
                return ((TRASACHRow[])(this.GetChildRows(this.Table.ChildRelations["MUONSACHTRASACH"])));
            }
        }
        ...
        [System.Diagnostics.DebuggerStepThrough()]
        public class TRASACHDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private DataColumn columnNGAYTRA;
            
            internal TRASACHDataTable() : 
                    base("TRASACH") {
                this.InitClass();
            }
            
            internal TRASACHDataTable(DataTable table) : 
                    base(table.TableName) {
                if ((table.CaseSensitive != table.DataSet.CaseSensitive)) {
                    this.CaseSensitive = table.CaseSensitive;
                }
            ...
            internal DataColumn NGAYTRAColumn {
                get {
            ...
            public TRASACHRow AddTRASACHRow(MUONSACHRow parentMUONSACHRowByMUONSACHTRASACH, QUYENSACHRow parentQUYENSACHRowByQUYENSACHTRASACH, string MSNV, System.DateTime NGAYTRA) {
                ...
                rowTRASACHRow.ItemArray = new object[] {
                        parentMUONSACHRowByMUONSACHTRASACH[0],
                        parentQUYENSACHRowByQUYENSACHTRASACH[0],
                        MSNV,
                        NGAYTRA};
            ...
            public TRASACHRow FindBySOPHIEUMUONMSSACH(System.Decimal SOPHIEUMUON, string MSSACH) {
            ...
            internal void InitVars() {
                ...
                this.columnMSNV = this.Columns["MSNV"];
                this.columnNGAYTRA = this.Columns["NGAYTRA"];
            }
            ...
            private void InitClass() {
                ...
                this.columnMSNV = new DataColumn("MSNV", typeof(string), null, System.Data.MappingType.Element);
                this.Columns.Add(this.columnMSNV);
                this.columnNGAYTRA = new DataColumn("NGAYTRA", typeof(System.DateTime), null, System.Data.MappingType.Element);
                this.Columns.Add(this.columnNGAYTRA);
                this.Constraints.Add(new UniqueConstraint("dtSachTraKey2", new DataColumn[] {
        ...
        [System.Diagnostics.DebuggerStepThrough()]
        public class TRASACHRow : DataRow {
            
            private TRASACHDataTable tableTRASACH;
            
            internal TRASACHRow(DataRowBuilder rb) : 
                    base(rb) {
            ...
            public System.Decimal SOPHIEUMUON {
                get {
                    return ((System.Decimal)(this[this.tableTRASACH.SOPHIEUMUONColumn]));
                }
                set {
            ...
            public System.DateTime NGAYTRA {
                get {
                    return ((System.DateTime)(this[this.tableTRASACH.NGAYTRAColumn]));
                }
                set {
            ...
            public void SetMSNVNull() {
                this[this.tableTRASACH.MSNVColumn] = System.Convert.DBNull;
            }
        }
        
        [System.Diagnostics.DebuggerStepThrough()]
        public class TRASACHRowChangeEvent : EventArgs {
            
            private TRASACHRow eventRow;
            
            private DataRowAction eventAction;
            
            public TRASACHRowChangeEvent(TRASACHRow row, DataRowAction action) {
                this.eventRow = row;
                this.eventAction = action;
            }
        ...
        public class QUYENSACHDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("dtSachTraKey3", new DataColumn[] {
                                this.columnMSSACH}, true));
                this.columnMSSACH.AllowDBNull = false;
        ...
        public class QUYENSACHRow : DataRow {
            ...
            public TRASACHRow[] GetTRASACHRows() {
                return ((TRASACHRow[])(this.GetChildRows(this.Table.ChildRelations["QUYENSACHTRASACH"])));
            }
        }
        ...
        public class DOCGIADataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("dtSachTraKey4", new DataColumn[] {
