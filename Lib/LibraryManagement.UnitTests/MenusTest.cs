...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="MenusTest"/> instance.
		/// </summary>	
		public MenusTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Menus objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Menus CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Menus mock = MenusTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Menus mock)
        {
            MenusTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Menus mock)
        {
