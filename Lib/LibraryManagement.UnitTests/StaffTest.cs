...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="StaffTest"/> instance.
		/// </summary>	
		public StaffTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Staff objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Staff CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Staff mock = StaffTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Staff mock)
        {
            StaffTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Staff mock)
        {
