...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CsCardTest"/> instance.
		/// </summary>	
		public CsCardTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  CsCard objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public CsCard CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            CsCard mock = CsCardTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, CsCard mock)
        {
            CsCardTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(CsCard mock)
        {
