...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		...
		/// <summary>
		/// Selects a sample of  Account objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Account CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Account mock = AccountTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Account mock)
        {
            AccountTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Account mock)
        {
