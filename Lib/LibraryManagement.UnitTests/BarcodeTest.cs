...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="BarcodeTest"/> instance.
		/// </summary>	
		public BarcodeTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Barcode objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Barcode CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Barcode mock = BarcodeTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Barcode mock)
        {
            BarcodeTest.UpdateMockInstance_Generated(tm, mock);
