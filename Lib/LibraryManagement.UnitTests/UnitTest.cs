...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="UnitTest"/> instance.
		/// </summary>	
		public UnitTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Unit objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Unit CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Unit mock = UnitTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Unit mock)
        {
            UnitTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Unit mock)
        {
