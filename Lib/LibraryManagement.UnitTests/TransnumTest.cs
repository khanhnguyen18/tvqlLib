...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TransnumTest"/> instance.
		/// </summary>	
		public TransnumTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Transnum objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Transnum CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Transnum mock = TransnumTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Transnum mock)
        {
            TransnumTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Transnum mock)
        {
