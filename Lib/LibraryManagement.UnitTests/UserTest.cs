...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="UserTest"/> instance.
		/// </summary>	
		public UserTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  User objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public User CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            User mock = UserTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, User mock)
        {
            UserTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(User mock)
        {
