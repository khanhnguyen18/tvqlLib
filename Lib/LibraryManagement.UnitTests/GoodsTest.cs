...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="GoodsTest"/> instance.
		/// </summary>	
		public GoodsTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Goods objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Goods CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Goods mock = GoodsTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Goods mock)
        {
            GoodsTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Goods mock)
        {
