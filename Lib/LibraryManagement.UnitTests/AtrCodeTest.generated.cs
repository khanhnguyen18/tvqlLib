...
/*
	...
	Important: Do not modify this file. Edit the file AtrCodeTest.cs instead.
*/
...
namespace LibraryManagement.UnitTests
{
   ...
   public partial class AtrCodeTest
    {
    	// the AtrCode instance used to test the repository.
		protected AtrCode mock;
		
		// the TList<AtrCode> instance used to test the repository.
		protected TList<AtrCode> mockCollection;
        ...
        {		
			...
			System.Console.WriteLine("-- Testing the AtrCode Entity with the {0} --", LibraryManagement.Dao.DataRepository.Provider.Name);
			System.Console.WriteLine(new String('-', 75));
        }
		...
		/// <summary>
		/// Selects all AtrCode objects of the database.
		/// </summary>
		private void Step_02_SelectAll_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				mockCollection = DataRepository.AtrCodeProvider.Find(tm, null, "", 0, 10, out count );
				Assert.IsTrue(count >= 0 && mockCollection != null, "Query Failed to issue Find Command.");
				
				System.Console.WriteLine("DataRepository.AtrCodeProvider.Find():");			
		...
		private void Step_04_Update_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				Assert.IsTrue(DataRepository.AtrCodeProvider.Update(tm, mock), "Update failed.");			
				
				System.Console.WriteLine("DataRepository.AtrCodeProvider.Update(mock):");			
				System.Console.WriteLine(mock);
		...
		private void Step_05_Delete_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				mock =  (AtrCode)CreateMockInstance(tm);
				DataRepository.AtrCodeProvider.Insert(tm, mock);
			
				Assert.IsTrue(DataRepository.AtrCodeProvider.Delete(tm, mock), "Delete failed.");
				System.Console.WriteLine("DataRepository.AtrCodeProvider.Delete(mock):");			
				System.Console.WriteLine(mock);
		...
		private void Step_07_DeserializeEntity_Generated()
		{
			...
			{
				object item = EntityHelper.DeserializeEntityXml<AtrCode>(sr.ReadToEnd());
				sr.Close();
			}
		...
		private void Step_09_DeserializeCollection_Generated()
		{
			...
			XmlSerializer mySerializer = new XmlSerializer(typeof(TList<AtrCode>)); 
			using (System.IO.FileStream myFileStream = new System.IO.FileStream(fileName,  System.IO.FileMode.Open))
			{
				TList<AtrCode> mockCollection = (TList<AtrCode>) mySerializer.Deserialize(myFileStream);
				myFileStream.Close();
			}
			
			System.IO.File.Delete(fileName);
			System.Console.WriteLine("TList<AtrCode> correctly deserialized from a temporary file.");	
		}
		#endregion
		...
		private void Step_11_IX_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				AtrCode t0 = DataRepository.AtrCodeProvider.GetByTransCode(tm, entity.TransCode);
			}
		}
