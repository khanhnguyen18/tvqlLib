...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="StockInfoTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  StockInfo objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public StockInfo CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            StockInfo mock = StockInfoTest.CreateMockInstance_Generated(tm);
        ...
        static private void SetSpecialTestData(StockInfo mock)
        {
