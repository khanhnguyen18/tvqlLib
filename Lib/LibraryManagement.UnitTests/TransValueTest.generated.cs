...
/*
	...
	Important: Do not modify this file. Edit the file TransValueTest.cs instead.
*/
...
namespace LibraryManagement.UnitTests
{
   ...
   public partial class TransValueTest
    {
    	// the TransValue instance used to test the repository.
		protected TransValue mock;
		
		// the TList<TransValue> instance used to test the repository.
		protected TList<TransValue> mockCollection;
        ...
        {		
			...
			System.Console.WriteLine("-- Testing the TransValue Entity with the {0} --", LibraryManagement.Dao.DataRepository.Provider.Name);
			System.Console.WriteLine(new String('-', 75));
        }
		...
		/// <summary>
		/// Selects all TransValue objects of the database.
		/// </summary>
		private void Step_02_SelectAll_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				mockCollection = DataRepository.TransValueProvider.Find(tm, null, "", 0, 10, out count );
				Assert.IsTrue(count >= 0 && mockCollection != null, "Query Failed to issue Find Command.");
				
				System.Console.WriteLine("DataRepository.TransValueProvider.Find():");			
		...
		private void Step_04_Update_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				Assert.IsTrue(DataRepository.TransValueProvider.Update(tm, mock), "Update failed.");			
				
				System.Console.WriteLine("DataRepository.TransValueProvider.Update(mock):");			
				System.Console.WriteLine(mock);
		...
		private void Step_05_Delete_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				mock =  (TransValue)CreateMockInstance(tm);
				DataRepository.TransValueProvider.Insert(tm, mock);
			
				Assert.IsTrue(DataRepository.TransValueProvider.Delete(tm, mock), "Delete failed.");
				System.Console.WriteLine("DataRepository.TransValueProvider.Delete(mock):");			
				System.Console.WriteLine(mock);
		...
		private void Step_07_DeserializeEntity_Generated()
		{
			...
			{
				object item = EntityHelper.DeserializeEntityXml<TransValue>(sr.ReadToEnd());
				sr.Close();
			}
		...
		private void Step_09_DeserializeCollection_Generated()
		{
			...
			XmlSerializer mySerializer = new XmlSerializer(typeof(TList<TransValue>)); 
			using (System.IO.FileStream myFileStream = new System.IO.FileStream(fileName,  System.IO.FileMode.Open))
			{
				TList<TransValue> mockCollection = (TList<TransValue>) mySerializer.Deserialize(myFileStream);
				myFileStream.Close();
			}
			
			System.IO.File.Delete(fileName);
			System.Console.WriteLine("TList<TransValue> correctly deserialized from a temporary file.");	
		}
		#endregion
		...
		private void Step_11_IX_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				TransValue t0 = DataRepository.TransValueProvider.GetByTransNum(tm, entity.TransNum);
			}
		}
