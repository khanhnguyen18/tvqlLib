...
{
    /// <summary>
    /// Provides tests for the and <see cref="AtrCode"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
	/// This file is generated once and will never be overwritten.
	/// </remarks>
    [TestFixture]
    public partial class AtrCodeTest
    {    	
		/// <summary>
		/// Creates a new <see cref="AtrCodeTest"/> instance.
		/// </summary>	
		public AtrCodeTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  AtrCode objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Updates a mock AtrCode entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Delete the mock AtrCode entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize the mock AtrCode entity from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize a AtrCode collection from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
