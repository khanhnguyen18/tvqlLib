...
{
    /// <summary>
    /// Provides tests for the and <see cref="Date"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="DateTest"/> instance.
		/// </summary>	
		public DateTest()
		{				
		}
		...
		/// <summary>
		/// Inserts a mock Date entity into the database.
		/// </summary>
		...
		/// <summary>
		/// Selects a sample of  Date objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Updates a mock Date entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Delete the mock Date entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Serialize the mock Date entity into a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize the mock Date entity from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Serialize a Date collection into a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize a Date collection from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///<summary>
        ///  Returns a Typed Date Entity with mock values.
        ///</summary>
        static public Date CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Date mock = DateTest.CreateMockInstance_Generated(tm);
        ...
        ///<summary>
        ///  Update the Typed Date Entity with modified mock values.
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Date mock)
        {
            DateTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Date mock)
        {
