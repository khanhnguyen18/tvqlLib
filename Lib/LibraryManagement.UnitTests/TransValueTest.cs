...
{
    /// <summary>
    /// Provides tests for the and <see cref="TransValue"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
	/// This file is generated once and will never be overwritten.
	/// </remarks>
    [TestFixture]
    public partial class TransValueTest
    {    	
		/// <summary>
		/// Creates a new <see cref="TransValueTest"/> instance.
		/// </summary>	
		public TransValueTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  TransValue objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Updates a mock TransValue entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Delete the mock TransValue entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize the mock TransValue entity from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize a TransValue collection from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
