...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TransactionTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  Transaction objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Transaction CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Transaction mock = TransactionTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Transaction mock)
        {
            TransactionTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Transaction mock)
        {
