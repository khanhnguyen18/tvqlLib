   ...
   public partial class CustomerTest
    {
        ...
        {		
			...
			System.Console.WriteLine("-- Testing the Customer Entity with the {0} --", LibraryManagement.Dao.DataRepository.Provider.Name);
			System.Console.WriteLine(new String('-', 75));
        }
		...
		private void Step_11_IX_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				Customer t0 = DataRepository.CustomerProvider.GetById(tm, entity.Id);
			}
		}
