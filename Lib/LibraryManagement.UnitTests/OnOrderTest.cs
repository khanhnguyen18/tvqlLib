...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="OnOrderTest"/> instance.
		/// </summary>	
		public OnOrderTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  OnOrder objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public OnOrder CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            OnOrder mock = OnOrderTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, OnOrder mock)
        {
            OnOrderTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(OnOrder mock)
        {
