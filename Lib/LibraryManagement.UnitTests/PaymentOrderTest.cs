...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PaymentOrderTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  PaymentOrder objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(PaymentOrder mock)
        {
