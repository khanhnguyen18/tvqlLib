...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="MercLocationTest"/> instance.
		/// </summary>	
		public MercLocationTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  MercLocation objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public MercLocation CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            MercLocation mock = MercLocationTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, MercLocation mock)
        {
            MercLocationTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(MercLocation mock)
        {
