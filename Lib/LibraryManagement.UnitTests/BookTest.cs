...
namespace LibraryManagement.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="BookTest"/> instance.
		/// </summary>	
		public BookTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Book objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Book CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Book mock = BookTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Book mock)
        {
            BookTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Book mock)
        {
