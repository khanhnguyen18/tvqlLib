/*
	...
	Important: Do not modify this file. Edit the file SqlBarcodeProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlBarcodeProviderBase : BarcodeProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlBarcodeProviderBase"/> instance.
		/// </summary>
		public SqlBarcodeProviderBase()
		{
		}
	...
	public SqlBarcodeProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _barcode)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Barcode)
					,_barcode);
		...
		public override TList<Barcode> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@GoodsId", DbType.AnsiStringFixedLength, DBNull.Value);
			...
			//Create Collection
			TList<Barcode> rows = new TList<Barcode>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.Barcode objects.</returns>
		public override TList<Barcode> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override LibraryManagement.Domain.Barcode GetByBarcode(TransactionManager transactionManager, System.String _barcode, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<Barcode> tmp = new TList<Barcode>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByBarcode", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByBarcode", tmp));
			}
			finally 
			{
				if (reader != null) 
