/*
	...
	Important: Do not modify this file. Edit the file SqlKitProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlKitProviderBase : KitProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlKitProviderBase"/> instance.
		/// </summary>
		public SqlKitProviderBase()
		{
		}
	...
	public SqlKitProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _id)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Kit)
					,_id);
		...
		public override TList<Kit> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@Unitsymb", DbType.StringFixedLength, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Status", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("unitsymb ") || clause.Trim().StartsWith("unitsymb="))
				{
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.Kit objects.</returns>
		public override TList<Kit> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override bool Insert(TransactionManager transactionManager, LibraryManagement.Domain.Kit entity)
		{
            ...
            database.AddInParameter(commandWrapper, "@Unitsymb", DbType.StringFixedLength, entity.Unitsymb );
