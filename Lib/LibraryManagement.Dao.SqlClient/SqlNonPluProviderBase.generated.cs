/*
	...
	Important: Do not modify this file. Edit the file SqlNonPluProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlNonPluProviderBase : NonPluProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlNonPluProviderBase"/> instance.
		/// </summary>
		public SqlNonPluProviderBase()
		{
		}
	...
	public SqlNonPluProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _npluCode, System.String _goodsId)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(NonPlu)
					,_npluCode,_goodsId);
		...
		public override TList<NonPlu> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@NpluCode", DbType.AnsiStringFixedLength, DBNull.Value);
		database.AddInParameter(commandWrapper, "@GoodsId", DbType.StringFixedLength, DBNull.Value);
			...
			{
				if (clause.Trim().StartsWith("nplu_code ") || clause.Trim().StartsWith("nplu_code="))
				{
					database.SetParameterValue(commandWrapper, "@NpluCode", 
			...
			//Create Collection
			TList<NonPlu> rows = new TList<NonPlu>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.NonPlu objects.</returns>
		public override TList<NonPlu> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override LibraryManagement.Domain.NonPlu GetByNpluCodeGoodsId(TransactionManager transactionManager, System.String _npluCode, System.String _goodsId, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<NonPlu> tmp = new TList<NonPlu>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByNpluCodeGoodsId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByNpluCodeGoodsId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<LibraryManagement.Domain.NonPlu> entities)
		{
			...
			bulkCopy.DestinationTableName = "tblNon_Plu";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("nplu_code", typeof(System.String));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("goods_id", typeof(System.String));
			col1.AllowDBNull = false;		
			
			bulkCopy.ColumnMappings.Add("nplu_code", "nplu_code");
			bulkCopy.ColumnMappings.Add("goods_id", "goods_id");
			
			foreach(LibraryManagement.Domain.NonPlu entity in entities)
			{
