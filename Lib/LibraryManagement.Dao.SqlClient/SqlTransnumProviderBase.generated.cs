/*
	...
	Important: Do not modify this file. Edit the file SqlTransnumProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlTransnumProviderBase : TransnumProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlTransnumProviderBase"/> instance.
		/// </summary>
		public SqlTransnumProviderBase()
		{
		}
	...
	public SqlTransnumProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _transType)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Transnum)
					,_transType);
		...
		public override TList<Transnum> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@TransType", DbType.AnsiStringFixedLength, DBNull.Value);
		database.AddInParameter(commandWrapper, "@LastNum", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@LastDate", DbType.DateTime, DBNull.Value);
			...
			{
				if (clause.Trim().StartsWith("trans_type ") || clause.Trim().StartsWith("trans_type="))
				{
					database.SetParameterValue(commandWrapper, "@TransType", 
						clause.Trim().Remove(0,10).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("last_num ") || clause.Trim().StartsWith("last_num="))
				{
					database.SetParameterValue(commandWrapper, "@LastNum", 
			...
			//Create Collection
			TList<Transnum> rows = new TList<Transnum>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.Transnum objects.</returns>
		public override TList<Transnum> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override LibraryManagement.Domain.Transnum GetByTransType(TransactionManager transactionManager, System.String _transType, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<Transnum> tmp = new TList<Transnum>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByTransType", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByTransType", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<LibraryManagement.Domain.Transnum> entities)
		{
			...
			bulkCopy.DestinationTableName = "tblTransnum";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("trans_type", typeof(System.String));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("last_num", typeof(System.Decimal));
			...
			bulkCopy.ColumnMappings.Add("last_num", "last_num");
			bulkCopy.ColumnMappings.Add("last_date", "last_date");
			
			foreach(LibraryManagement.Domain.Transnum entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["trans_type"] = entity.TransType;
							
				
					row["last_num"] = entity.LastNum;
		...
		public override bool Insert(TransactionManager transactionManager, LibraryManagement.Domain.Transnum entity)
		{
			...
			entity.OriginalTransType = entity.TransType;
