/*
	...
	Important: Do not modify this file. Edit the file SqlPriceProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlPriceProviderBase : PriceProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlPriceProviderBase"/> instance.
		/// </summary>
		public SqlPriceProviderBase()
		{
		}
	...
	public SqlPriceProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _goodsId)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Price)
					,_goodsId);
		...
		public override TList<Price> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@Rtprice", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Averimppr", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Lastimppr", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Wsprice", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Prefprice", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Discpercent", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@DiscFrdate", DbType.DateTime, DBNull.Value);
		database.AddInParameter(commandWrapper, "@DiscTodate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("rtprice ") || clause.Trim().StartsWith("rtprice="))
				{
					database.SetParameterValue(commandWrapper, "@Rtprice", 
				...
				if (clause.Trim().StartsWith("lastimppr ") || clause.Trim().StartsWith("lastimppr="))
				{
					database.SetParameterValue(commandWrapper, "@Lastimppr", 
						clause.Trim().Remove(0,9).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("wsprice ") || clause.Trim().StartsWith("wsprice="))
				{
					database.SetParameterValue(commandWrapper, "@Wsprice", 
						clause.Trim().Remove(0,7).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("prefprice ") || clause.Trim().StartsWith("prefprice="))
				{
					database.SetParameterValue(commandWrapper, "@Prefprice", 
						clause.Trim().Remove(0,9).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("discpercent ") || clause.Trim().StartsWith("discpercent="))
				{
					database.SetParameterValue(commandWrapper, "@Discpercent", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("disc_frdate ") || clause.Trim().StartsWith("disc_frdate="))
				{
					database.SetParameterValue(commandWrapper, "@DiscFrdate", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("disc_todate ") || clause.Trim().StartsWith("disc_todate="))
				{
					database.SetParameterValue(commandWrapper, "@DiscTodate", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			TList<Price> rows = new TList<Price>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.Price objects.</returns>
		public override TList<Price> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override LibraryManagement.Domain.Price GetByGoodsId(TransactionManager transactionManager, System.String _goodsId, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<Price> tmp = new TList<Price>();
			try
			{
				//Provider Data Requesting Command Event
		...
		public override bool Insert(TransactionManager transactionManager, LibraryManagement.Domain.Price entity)
		{
			...
			database.AddInParameter(commandWrapper, "@Lastimppr", DbType.Decimal, (entity.Lastimppr.HasValue ? (object) entity.Lastimppr  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@Wsprice", DbType.Decimal, (entity.Wsprice.HasValue ? (object) entity.Wsprice  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@Prefprice", DbType.Decimal, (entity.Prefprice.HasValue ? (object) entity.Prefprice  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@DiscFrdate", DbType.DateTime, (entity.DiscFrdate.HasValue ? (object) entity.DiscFrdate  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@DiscTodate", DbType.DateTime, (entity.DiscTodate.HasValue ? (object) entity.DiscTodate  : System.DBNull.Value));
