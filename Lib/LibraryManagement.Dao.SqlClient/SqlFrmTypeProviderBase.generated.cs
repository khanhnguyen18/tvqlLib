/*
	...
	Important: Do not modify this file. Edit the file SqlFrmTypeProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlFrmTypeProviderBase : FrmTypeProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlFrmTypeProviderBase"/> instance.
		/// </summary>
		public SqlFrmTypeProviderBase()
		{
		}
	...
	public SqlFrmTypeProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Decimal _id)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(FrmType)
					,_id);
		...
		public override TList<FrmType> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@Status", DbType.Boolean, DBNull.Value);
			...
			//Create Collection
			TList<FrmType> rows = new TList<FrmType>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.FrmType objects.</returns>
		public override TList<FrmType> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<LibraryManagement.Domain.FrmType> entities)
		{
			...
			bulkCopy.DestinationTableName = "tblFrmType";
			...
			foreach(LibraryManagement.Domain.FrmType entity in entities)
			{
