/*
	...
	Important: Do not modify this file. Edit the file SqlMercLocationProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlMercLocationProviderBase : MercLocationProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlMercLocationProviderBase"/> instance.
		/// </summary>
		public SqlMercLocationProviderBase()
		{
		}
	...
	public SqlMercLocationProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Decimal _idx)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(MercLocation)
					,_idx);
		...
		public override TList<MercLocation> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@Check", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("check ") || clause.Trim().StartsWith("check="))
				{
					database.SetParameterValue(commandWrapper, "@Check", 
			...
			//Create Collection
			TList<MercLocation> rows = new TList<MercLocation>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.MercLocation objects.</returns>
		public override TList<MercLocation> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override LibraryManagement.Domain.MercLocation GetByIdx(TransactionManager transactionManager, System.Decimal _idx, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<MercLocation> tmp = new TList<MercLocation>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<LibraryManagement.Domain.MercLocation> entities)
		{
			...
			bulkCopy.DestinationTableName = "tblMercLocation";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("idx", typeof(System.Decimal));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("stk_id", typeof(System.String));
			col1.AllowDBNull = false;		
			DataColumn col2 = dataTable.Columns.Add("loc_id", typeof(System.String));
			col2.AllowDBNull = false;		
			DataColumn col3 = dataTable.Columns.Add("goods_id", typeof(System.String));
			col3.AllowDBNull = false;		
			DataColumn col4 = dataTable.Columns.Add("check", typeof(System.Boolean));
			...
			bulkCopy.ColumnMappings.Add("check", "check");
			
			foreach(LibraryManagement.Domain.MercLocation entity in entities)
			{
