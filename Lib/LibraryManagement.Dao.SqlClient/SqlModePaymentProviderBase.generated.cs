/*
	...
	Important: Do not modify this file. Edit the file SqlModePaymentProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlModePaymentProviderBase : ModePaymentProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlModePaymentProviderBase"/> instance.
		/// </summary>
		public SqlModePaymentProviderBase()
		{
		}
	...
	public SqlModePaymentProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _pmtMode, System.String _forex)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(ModePayment)
					,_pmtMode,_forex);
		...
		public override TList<ModePayment> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@PmtMode", DbType.StringFixedLength, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Iscard", DbType.StringFixedLength, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Status", DbType.Boolean, DBNull.Value);
			...
			{
				if (clause.Trim().StartsWith("pmt_mode ") || clause.Trim().StartsWith("pmt_mode="))
				{
					database.SetParameterValue(commandWrapper, "@PmtMode", 
				...
				if (clause.Trim().StartsWith("iscard ") || clause.Trim().StartsWith("iscard="))
				{
					database.SetParameterValue(commandWrapper, "@Iscard", 
			...
			//Create Collection
			TList<ModePayment> rows = new TList<ModePayment>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.ModePayment objects.</returns>
		public override TList<ModePayment> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override bool Insert(TransactionManager transactionManager, LibraryManagement.Domain.ModePayment entity)
		{
            ...
            database.AddInParameter(commandWrapper, "@Iscard", DbType.StringFixedLength, entity.Iscard );
			...
			entity.OriginalPmtMode = entity.PmtMode;
			entity.OriginalForex = entity.Forex;
		...
		public override bool Update(TransactionManager transactionManager, LibraryManagement.Domain.ModePayment entity)
		{
            ...
            database.AddInParameter(commandWrapper, "@Description", DbType.String, entity.Description );
            database.AddInParameter(commandWrapper, "@Forex", DbType.StringFixedLength, entity.Forex );
			database.AddInParameter(commandWrapper, "@OriginalForex", DbType.StringFixedLength, entity.OriginalForex);
			database.AddInParameter(commandWrapper, "@ForexRate", DbType.Decimal, (entity.ForexRate.HasValue ? (object) entity.ForexRate : System.DBNull.Value) );
            database.AddInParameter(commandWrapper, "@Iscard", DbType.StringFixedLength, entity.Iscard );
			database.AddInParameter(commandWrapper, "@Status", DbType.Boolean, (entity.Status.HasValue ? (object) entity.Status : System.DBNull.Value) );
