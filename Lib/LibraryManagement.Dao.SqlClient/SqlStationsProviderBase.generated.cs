/*
	...
	Important: Do not modify this file. Edit the file SqlStationsProvider.cs instead.
*/
...
namespace LibraryManagement.Dao.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlStationsProviderBase : StationsProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlStationsProviderBase"/> instance.
		/// </summary>
		public SqlStationsProviderBase()
		{
		}
	...
	public SqlStationsProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblStations_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Stations)
					,_id);
		...
		public override TList<Stations> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<Stations>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblStations_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@Login", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@UserId", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@PosId", DbType.AnsiStringFixedLength, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Prnport", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Ipaddress", DbType.StringFixedLength, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Message", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Serialkey", DbType.StringFixedLength, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Status", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("pos_id ") || clause.Trim().StartsWith("pos_id="))
				{
					database.SetParameterValue(commandWrapper, "@PosId", 
						clause.Trim().Remove(0,6).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("prnport ") || clause.Trim().StartsWith("prnport="))
				{
					database.SetParameterValue(commandWrapper, "@Prnport", 
						clause.Trim().Remove(0,7).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				...
				if (clause.Trim().StartsWith("serialkey ") || clause.Trim().StartsWith("serialkey="))
				{
					database.SetParameterValue(commandWrapper, "@Serialkey", 
						clause.Trim().Remove(0,9).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			TList<Stations> rows = new TList<Stations>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.Stations objects.</returns>
		public override TList<Stations> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblStations_Find_Dynamic", typeof(StationsColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Stations> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblStations_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of LibraryManagement.Domain.Stations objects.</returns>
		public override TList<Stations> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblStations_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override LibraryManagement.Domain.Stations GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblStations_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<Stations> tmp = new TList<Stations>();
			try
			{
				//Provider Data Requesting Command Event
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, LibraryManagement.Domain.Stations entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblStations_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@Login", DbType.Int32, (entity.Login.HasValue ? (object) entity.Login  : System.DBNull.Value));
            ...
            database.AddInParameter(commandWrapper, "@PosId", DbType.AnsiStringFixedLength, entity.PosId );
			database.AddInParameter(commandWrapper, "@Prnport", DbType.Int32, (entity.Prnport.HasValue ? (object) entity.Prnport  : System.DBNull.Value));
            database.AddInParameter(commandWrapper, "@Ipaddress", DbType.StringFixedLength, entity.Ipaddress );
			database.AddInParameter(commandWrapper, "@Message", DbType.Boolean, (entity.Message.HasValue ? (object) entity.Message  : System.DBNull.Value));
            database.AddInParameter(commandWrapper, "@Serialkey", DbType.StringFixedLength, entity.Serialkey );
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, LibraryManagement.Domain.Stations entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblStations_Update", _useStoredProcedure);
