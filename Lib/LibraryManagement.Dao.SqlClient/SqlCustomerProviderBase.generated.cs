...
namespace LibraryManagement.Dao.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblCustomer_Delete", _useStoredProcedure);
		...
		public override TList<Customer> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblCustomer_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@PlaceIssue", DbType.String, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Email", DbType.StringFixedLength, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Status", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("place_issue ") || clause.Trim().StartsWith("place_issue="))
				{
		...
		public override TList<Customer> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblCustomer_Find_Dynamic", typeof(CustomerColumn), filter, orderBy, start, pageLength);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblCustomer_Get_List", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblCustomer_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override LibraryManagement.Domain.Customer GetById(TransactionManager transactionManager, System.String _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblCustomer_GetById", _useStoredProcedure);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<LibraryManagement.Domain.Customer> entities)
		{
			...
			DataColumn col1 = dataTable.Columns.Add("Type", typeof(System.Int32));
			...
			DataColumn col6 = dataTable.Columns.Add("person_id", typeof(System.String));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("place_issue", typeof(System.String));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("email", typeof(System.String));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("due_date", typeof(System.DateTime));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("image", typeof(System.Byte[]));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("bankname", typeof(System.String));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("bank_br", typeof(System.String));
			col12.AllowDBNull = true;		
			DataColumn col13 = dataTable.Columns.Add("accnum", typeof(System.String));
			col13.AllowDBNull = true;		
			DataColumn col14 = dataTable.Columns.Add("Vatnum", typeof(System.String));
			col14.AllowDBNull = true;		
			DataColumn col15 = dataTable.Columns.Add("contactps", typeof(System.String));
			col15.AllowDBNull = true;		
			DataColumn col16 = dataTable.Columns.Add("remark", typeof(System.String));
			col16.AllowDBNull = true;		
			DataColumn col17 = dataTable.Columns.Add("open_date", typeof(System.DateTime));
			...
			bulkCopy.ColumnMappings.Add("place_issue", "place_issue");
			...
			foreach(LibraryManagement.Domain.Customer entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["place_issue"] = entity.PlaceIssue;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, LibraryManagement.Domain.Customer entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblCustomer_Insert", _useStoredProcedure);
            ...
            database.AddInParameter(commandWrapper, "@PlaceIssue", DbType.String, entity.PlaceIssue );
            database.AddInParameter(commandWrapper, "@Email", DbType.StringFixedLength, entity.Email );
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, LibraryManagement.Domain.Customer entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.usptblCustomer_Update", _useStoredProcedure);
