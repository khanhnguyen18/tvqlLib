...
{		
	...
	public partial class LanguageServiceBase : ServiceBase<Language, LanguageKey>
	{
		...
		public static Language CreateLanguage(System.Decimal _id, System.String _description, System.Boolean _status)
		{
			...
			newEntityLanguage.Description  = _description;
			newEntityLanguage.Status  = _status;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{Language}" /> from the datasource based on the primary key PK_tblLanguage index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="Language"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language GetById(System.Decimal _id)
		{
            ...
            {	
				...
				entity = dataProvider.LanguageProvider.GetById(transactionManager, _id)   as Language;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="Language"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language GetById(System.Decimal _id, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language DeepLoadById(System.Decimal _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
