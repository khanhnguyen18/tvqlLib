...
{		
	...
	public partial class AccountServiceBase : ServiceBase<Account, AccountKey>
	{
		...
		public static Account CreateAccount(System.Decimal _branch, System.String _accountId, System.String _abbreviat, System.String _mofGl, System.String _custId, System.String _name, System.DateTime _openDate, System.DateTime _prevDate, System.DateTime _lastDate, System.Decimal _creamt, System.Decimal _debamt, System.Boolean _status)
		{
			Account newEntityAccount = new Account();
			newEntityAccount.Branch  = _branch;
			newEntityAccount.AccountId  = _accountId;
			newEntityAccount.Abbreviat  = _abbreviat;
			newEntityAccount.MofGl  = _mofGl;
			newEntityAccount.CustId  = _custId;
			newEntityAccount.Name  = _name;
			newEntityAccount.OpenDate  = _openDate;
			newEntityAccount.PrevDate  = _prevDate;
			newEntityAccount.LastDate  = _lastDate;
			newEntityAccount.Creamt  = _creamt;
			newEntityAccount.Debamt  = _debamt;
			newEntityAccount.Status  = _status;
		...
		{
			return GetByBranchAccountId(key.Branch, key.AccountId);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{Account}" /> from the datasource based on the primary key PK_tblAccount_1 index.
		/// </summary>
		/// <param name="_branch"></param>
		/// <param name="_accountId"></param>
		/// <returns>Returns an instance of the <see cref="Account"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Account GetByBranchAccountId(System.Decimal _branch, System.String _accountId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByBranchAccountId");
            ...
            {	
				...
				entity = dataProvider.AccountProvider.GetByBranchAccountId(transactionManager, _branch, _accountId)   as Account;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="Account"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Account GetByBranchAccountId(System.Decimal _branch, System.String _accountId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByBranchAccountId");
            ...
            {	
				...
				entity = dataProvider.AccountProvider.GetByBranchAccountId(transactionManager, _branch, _accountId, start, pageLength, out totalCount)   as Account;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		{
			return Delete(key.Branch, key.AccountId );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Decimal _branch, System.String _accountId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				result = dataProvider.AccountProvider.Delete(transactionManager, _branch, _accountId);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Account DeepLoadByBranchAccountId(System.Decimal _branch, System.String _accountId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByBranchAccountId");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Account entity = GetByBranchAccountId(_branch, _accountId);
