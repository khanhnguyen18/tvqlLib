...
{		
	...
	public partial class CurrencyServiceBase : ServiceBase<Currency, CurrencyKey>
	{
		...
		public static Currency CreateCurrency(System.String _id, System.String _description, System.Decimal? _exchange, System.Boolean? _status)
		{
			Currency newEntityCurrency = new Currency();
			newEntityCurrency.Id  = _id;
			newEntityCurrency.Description  = _description;
			newEntityCurrency.Exchange  = _exchange;
			newEntityCurrency.Status  = _status;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{Currency}" /> from the datasource based on the primary key PK_tblCurrency index.
		/// </summary>
		/// <param name="_id"></param>
		...
		public virtual Currency GetById(System.String _id)
		{
            ...
            {	
				...
				entity = dataProvider.CurrencyProvider.GetById(transactionManager, _id)   as Currency;
			}
            catch (Exception exc)
            {
