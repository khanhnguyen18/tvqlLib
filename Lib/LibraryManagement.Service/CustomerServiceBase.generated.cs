...
{		
	...
	public partial class CustomerServiceBase : ServiceBase<Customer, CustomerKey>
	{
		...
		public static Customer CreateCustomer(System.String _id, System.Int32? _type, System.String _fullname, System.String _address, System.String _phone, System.String _fax, System.String _personId, System.String _placeIssue, System.String _email, System.DateTime? _dueDate, System.Byte[] _image, System.String _bankname, System.String _bankBr, System.String _accnum, System.String _vatnum, System.String _contactps, System.String _remark, System.DateTime? _openDate, System.Boolean _status)
		{
			Customer newEntityCustomer = new Customer();
			newEntityCustomer.Id  = _id;
			newEntityCustomer.Type  = _type;
			newEntityCustomer.Fullname  = _fullname;
			newEntityCustomer.Address  = _address;
			newEntityCustomer.Phone  = _phone;
			newEntityCustomer.Fax  = _fax;
			newEntityCustomer.PersonId  = _personId;
			newEntityCustomer.PlaceIssue  = _placeIssue;
			newEntityCustomer.Email  = _email;
			newEntityCustomer.DueDate  = _dueDate;
			newEntityCustomer.Image  = _image;
			newEntityCustomer.Bankname  = _bankname;
			newEntityCustomer.BankBr  = _bankBr;
			newEntityCustomer.Accnum  = _accnum;
			newEntityCustomer.Vatnum  = _vatnum;
			newEntityCustomer.Contactps  = _contactps;
			newEntityCustomer.Remark  = _remark;
			newEntityCustomer.OpenDate  = _openDate;
			newEntityCustomer.Status  = _status;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{Customer}" /> from the datasource based on the primary key PK_tblCustomer index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="Customer"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Customer GetById(System.String _id)
		{
            ...
            {	
				...
				entity = dataProvider.CustomerProvider.GetById(transactionManager, _id)   as Customer;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="Customer"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Customer GetById(System.String _id, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Customer DeepLoadById(System.String _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
