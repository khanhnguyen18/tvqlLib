...
{		
	...
	/// All custom implementations should be done in the <see cref="GoodsGrp"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class GoodsGrpServiceBase : ServiceBase<GoodsGrp, GoodsGrpKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="GoodsGrp"/> instance .
		///</summary>
		public GoodsGrpServiceBase() : base()
		{
		}
		...
		{
			GoodsGrp newEntityGoodsGrp = new GoodsGrp();
			newEntityGoodsGrp.Id  = _id;
			newEntityGoodsGrp.Description  = _description;
			newEntityGoodsGrp.Status  = _status;
			return newEntityGoodsGrp;
		}
		#endregion Constructors

		#region Fields
		private static SecurityContext<GoodsGrp> securityContext = new SecurityContext<GoodsGrp>();
		...
		///</summary>
		public static SecurityContext<GoodsGrp> SecurityContext
		{
			get
			{
		...
		public override GoodsGrp Get(GoodsGrpKey key)
		{
			return GetById(key.Id);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{GoodsGrp}" /> from the datasource based on the primary key PK_tblGoodsGrp index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="GoodsGrp"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual GoodsGrp GetById(System.String _id)
		{
            ...
            {	
				...
				entity = dataProvider.GoodsGrpProvider.GetById(transactionManager, _id)   as GoodsGrp;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="GoodsGrp"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual GoodsGrp GetById(System.String _id, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
            ...
            {	
				...
				entity = dataProvider.GoodsGrpProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as GoodsGrp;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="GoodsGrp" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<GoodsGrp> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.GoodsGrpProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="GoodsGrp" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{GoodsGrp}"/> </returns>
		public virtual TList<GoodsGrp> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.GoodsGrpProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{GoodsGrp}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>GoodsGrp</c> objects.</returns>
		public virtual TList<GoodsGrp> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>GoodsGrp</c> objects.</returns>
		public virtual TList<GoodsGrp> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{GoodsGrp}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>GoodsGrp</c> objects.</returns>
		public override TList<GoodsGrp> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.GoodsGrpProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<GoodsGrp> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.GoodsGrpProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<GoodsGrp> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.GoodsGrpProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>GoodsGrp</c> objects.</returns>
		public virtual TList<GoodsGrp> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>GoodsGrp</c> objects.</returns>
        public virtual TList<GoodsGrp> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>GoodsGrp</c> objects.</returns>
		public virtual TList<GoodsGrp> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.GoodsGrpProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>GoodsGrp</c> objects.</returns>
        public virtual TList<GoodsGrp> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>GoodsGrp</c> objects.</returns>
		public virtual TList<GoodsGrp> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.GoodsGrpProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(GoodsGrp entity)
		{
            ...
            {	
				...
				result = dataProvider.GoodsGrpProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{GoodsGrp}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>GoodsGrp</c> objects in a <see cref="TList{GoodsGrp}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<GoodsGrp> Insert(TList<GoodsGrp> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<GoodsGrp>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.GoodsGrpProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(GoodsGrp entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.GoodsGrpProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{GoodsGrp}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>GoodsGrp</c> objects in a <see cref="TList{GoodsGrp}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<GoodsGrp> Update(TList<GoodsGrp> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<GoodsGrp>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.GoodsGrpProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override GoodsGrp Save(GoodsGrp entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.GoodsGrpProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{GoodsGrp}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>GoodsGrp</c> objects in a <see cref="TList{GoodsGrp}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<GoodsGrp> Save(TList<GoodsGrp> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<GoodsGrp>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.GoodsGrpProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(GoodsGrp entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.GoodsGrpProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{GoodsGrp}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>GoodsGrp</c> objects in a <see cref="TList{GoodsGrp}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<GoodsGrp> Delete(TList<GoodsGrp> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<GoodsGrp>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.GoodsGrpProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(GoodsGrpKey key)
		{
		...
		public virtual bool Delete(System.String _id)
		{
			...
			try
            {
				...
				result = dataProvider.GoodsGrpProvider.Delete(transactionManager, _id);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="GoodsGrp"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="GoodsGrp"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual GoodsGrp DeepLoadById(System.String _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			GoodsGrp entity = GetById(_id);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(GoodsGrp)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(GoodsGrp entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(GoodsGrp entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="GoodsGrp"/> object to load.</param>
		...
		/// <param name="childTypes">GoodsGrp Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(GoodsGrp entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.GoodsGrpProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{GoodsGrp}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(GoodsGrp)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{GoodsGrp}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<GoodsGrp> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{GoodsGrp}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(GoodsGrp)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<GoodsGrp> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{GoodsGrp}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{GoodsGrp}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="GoodsGrp"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<GoodsGrp> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.GoodsGrpProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="GoodsGrp"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">GoodsGrp Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(GoodsGrp entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(GoodsGrp entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.GoodsGrpProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{GoodsGrp}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{GoodsGrp} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<GoodsGrp> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{GoodsGrp}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{GoodsGrp}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">GoodsGrp Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<GoodsGrp> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.GoodsGrpProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
