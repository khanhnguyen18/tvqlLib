...
{		
	...
	public partial class UserServiceBase : ServiceBase<User, UserKey>
	{
		...
		public static User CreateUser(System.Int32 _id, System.String _name, System.String _fullName, System.String _passw, System.String _mright, System.String _rpright, System.String _groups, System.Boolean? _status)
		{
			User newEntityUser = new User();
			newEntityUser.Id  = _id;
			newEntityUser.Name  = _name;
			newEntityUser.FullName  = _fullName;
			newEntityUser.Passw  = _passw;
			newEntityUser.Mright  = _mright;
			newEntityUser.Rpright  = _rpright;
			newEntityUser.Groups  = _groups;
			newEntityUser.Status  = _status;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{User}" /> from the datasource based on the primary key PK_tblUser index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="User"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User GetById(System.Int32 _id)
		{
            ...
            {	
				...
				entity = dataProvider.UserProvider.GetById(transactionManager, _id)   as User;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="User"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User GetById(System.Int32 _id, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
            ...
            {	
				...
				entity = dataProvider.UserProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as User;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual bool Delete(System.Int32 _id)
		{
			...
			try
            {
				...
				result = dataProvider.UserProvider.Delete(transactionManager, _id);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual User DeepLoadById(System.Int32 _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			User entity = GetById(_id);
