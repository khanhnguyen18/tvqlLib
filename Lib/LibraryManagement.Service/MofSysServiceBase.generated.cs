...
{		
	...
	/// All custom implementations should be done in the <see cref="MofSys"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class MofSysServiceBase : ServiceBase<MofSys, MofSysKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="MofSys"/> instance .
		///</summary>
		public MofSysServiceBase() : base()
		{
		}
		...
		public static MofSys CreateMofSys(System.String _mofGl, System.String _mofName, System.String _mofNameb, System.String _acType, System.String _negative, System.Boolean? _master, System.Int32? _glevel, System.Boolean _lastLevel, System.String _otherEqui)
		{
			MofSys newEntityMofSys = new MofSys();
			newEntityMofSys.MofGl  = _mofGl;
			newEntityMofSys.MofName  = _mofName;
			newEntityMofSys.MofNameb  = _mofNameb;
			newEntityMofSys.AcType  = _acType;
			newEntityMofSys.Negative  = _negative;
			newEntityMofSys.Master  = _master;
			newEntityMofSys.Glevel  = _glevel;
			newEntityMofSys.LastLevel  = _lastLevel;
			newEntityMofSys.OtherEqui  = _otherEqui;
			return newEntityMofSys;
		}
		#endregion Constructors

		#region Fields
		private static SecurityContext<MofSys> securityContext = new SecurityContext<MofSys>();
		...
		///</summary>
		public static SecurityContext<MofSys> SecurityContext
		{
			get
			{
		...
		public override MofSys Get(MofSysKey key)
		{
			return GetById(key.Id);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{MofSys}" /> from the datasource based on the primary key PK_tblMof_sys index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="MofSys"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual MofSys GetById(System.Decimal _id)
		{
            ...
            {	
				...
				entity = dataProvider.MofSysProvider.GetById(transactionManager, _id)   as MofSys;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="MofSys"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual MofSys GetById(System.Decimal _id, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
            ...
            {	
				...
				entity = dataProvider.MofSysProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as MofSys;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="MofSys" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<MofSys> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.MofSysProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="MofSys" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{MofSys}"/> </returns>
		public virtual TList<MofSys> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.MofSysProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{MofSys}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>MofSys</c> objects.</returns>
		public virtual TList<MofSys> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>MofSys</c> objects.</returns>
		public virtual TList<MofSys> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{MofSys}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>MofSys</c> objects.</returns>
		public override TList<MofSys> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.MofSysProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<MofSys> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.MofSysProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<MofSys> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.MofSysProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>MofSys</c> objects.</returns>
		public virtual TList<MofSys> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>MofSys</c> objects.</returns>
        public virtual TList<MofSys> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>MofSys</c> objects.</returns>
		public virtual TList<MofSys> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.MofSysProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>MofSys</c> objects.</returns>
        public virtual TList<MofSys> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>MofSys</c> objects.</returns>
		public virtual TList<MofSys> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.MofSysProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(MofSys entity)
		{
            ...
            {	
				...
				result = dataProvider.MofSysProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{MofSys}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>MofSys</c> objects in a <see cref="TList{MofSys}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<MofSys> Insert(TList<MofSys> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<MofSys>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.MofSysProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(MofSys entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.MofSysProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{MofSys}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>MofSys</c> objects in a <see cref="TList{MofSys}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<MofSys> Update(TList<MofSys> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<MofSys>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.MofSysProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override MofSys Save(MofSys entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.MofSysProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{MofSys}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>MofSys</c> objects in a <see cref="TList{MofSys}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<MofSys> Save(TList<MofSys> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<MofSys>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.MofSysProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(MofSys entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.MofSysProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{MofSys}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>MofSys</c> objects in a <see cref="TList{MofSys}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<MofSys> Delete(TList<MofSys> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<MofSys>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.MofSysProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(MofSysKey key)
		{
		...
		public virtual bool Delete(System.Decimal _id)
		{
			...
			try
            {
				...
				result = dataProvider.MofSysProvider.Delete(transactionManager, _id);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="MofSys"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="MofSys"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual MofSys DeepLoadById(System.Decimal _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			MofSys entity = GetById(_id);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(MofSys)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(MofSys entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(MofSys entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="MofSys"/> object to load.</param>
		...
		/// <param name="childTypes">MofSys Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(MofSys entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.MofSysProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{MofSys}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(MofSys)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{MofSys}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<MofSys> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{MofSys}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(MofSys)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<MofSys> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{MofSys}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{MofSys}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="MofSys"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<MofSys> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.MofSysProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="MofSys"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">MofSys Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(MofSys entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(MofSys entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.MofSysProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{MofSys}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{MofSys} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<MofSys> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{MofSys}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{MofSys}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">MofSys Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<MofSys> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.MofSysProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
