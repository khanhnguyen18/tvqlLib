...
namespace LibraryManagement.App
{
    public partial class FrmMercList : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btn_History_Click(object sender, EventArgs e)
        {
            ...
            {
                this.string_1 = string.Concat(new object[] { "select * from tblTransaction where goods_id = '", this.string_2, "' and (tran_date between '", Class7.dateTimeFrom, "' and '", Class7.dateTimeTo, "')  and status = 1  order by tran_date, tran_time " });
