    ...
    public partial class FrmFromSuppOd : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void method_2()
        {
            ...
            if (dataSet.Tables[0].Rows.Count != 0)
            {
                ...
                num4 = Class7.ParseDoubleValue(dataSet.Tables[0].Rows[0]["d_amt"].ToString());
                num3 = Class7.ParseDoubleValue(dataSet.Tables[0].Rows[0]["v_amt"].ToString());
                if (this.chk_inclVat.Checked)
                {
                    this.Txt_TotalAmt.EditValue = num2 + num3;
                    this.Txt_ImpAmt.EditValue = Class7.ParseDoubleValue(this.Txt_TotalAmt.Text) - num3;
