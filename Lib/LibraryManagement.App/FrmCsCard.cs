...
namespace LibraryManagement.App
{
    public partial class FrmCsCard : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Class7.smethod_15("Bạn chắc chắn muốn x\x00f3a m\x00e3 thẻ n\x00e0y ? ", 2) == 1)
                {
            ...
            else if (Class7.smethod_15("Bạn chắc chắn muốn phục hồi m\x00e3 thẻ n\x00e0y ? ", 2) == 1)
            {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                Class7.smethod_15("Bạn chưa đăng k\x00fd t\x00ean kh\x00e1ch h\x00e0ng", 1);
                this.Txt_FullName.Focus();
            }
            else
            {
