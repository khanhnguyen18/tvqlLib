...
{
    public partial class FrmFromSuppNoVat : DevExpress.XtraEditors.XtraForm
    {
        public FrmFromSuppNoVat()
        {
            InitializeComponent();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (num2 <= 0.0)
                {
                    Class7.smethod_15("Gi\x00e1 nhập đăng k\x00fd kh\x00f4ng hợp lệ", 1);
        ...
        private void CgeIdZyqWF_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void FrmFromSuppNoVat_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void FrmFromSuppNoVat_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmFromSuppNoVat_Load(object sender, EventArgs e)
        {
            DataSet set;
        ...
        private void IjSwogAv6(object sender, ButtonPressedEventArgs e)
        {
        }
        ...
        private void method_0()
        {
            ...
            this.CgeIdZyqWF.SelectedIndex = 0;
        ...
        private void method_4()
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                num4 = Class7.smethod_2(row["amount"]);
                double num9 = Class7.smethod_2(row["disc_pc"]);
                if (this.Chk_discpervat.Checked)
                {
                    if (this.Chk_includedisc.Checked)
                    {
                        num4 /= 1.0 + ((num9 / 100.0) / (1.0 - (num9 / 100.0)));
                    }
                    num5 = Math.Round((double)((num4 * (num9 / 100.0)) / (1.0 - (num9 / 100.0))), 2);
                    if (this.chk_inclVat.Checked)
                    {
                        num4 /= 1.0 + num3;
                    }
                ...
                else
                {
                    ...
                    if (this.Chk_includedisc.Checked)
                    {
                        num6 += (num9 / 100.0) / (1.0 - (num9 / 100.0));
                    }
                    num4 = Math.Round((double)(Class7.smethod_2(row["amount"]) / (1.0 + num6)), 2);
                    num5 = Math.Round((double)((num4 * (num9 / 100.0)) / (1.0 - (num9 / 100.0))), 2);
                }
                num7 = Math.Round((double)(num4 * num3), 2);
