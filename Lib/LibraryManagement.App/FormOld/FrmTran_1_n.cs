...
namespace LibraryManagement.App
{
    public partial class FrmTran_1_n : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            else if (Class7.smethod_0(this.Txt_DbAmt1.Text) <= 0.0)
            {
            ...
            else
            {
                ...
                double num2 = Class7.smethod_0(this.Txt_DbAmt1.Text);
                double num3 = Class7.smethod_0(this.Txt_DbAmt2.Text);
                double num = Class7.smethod_0(this.Txt_DbAmt3.Text);
                string str4 = this.Txt_Remark.Text.Trim();
                string str5 = this.ddvqeXfa4.Text.Trim();
                if (this.Lbl_CreAccName.Text == string.Empty)
                {
                    Class7.smethod_15("T\x00e0i khoản ghi c\x00f3 kh\x00f4ng hợp lệ", 1);
                ...
                else
                {
                    ...
                    if (str6 != null)
                    {
                        ...
                        else
                        {
                            ...
                            Class12.smethod_2(this.Txt_CreAccId.EditValue.ToString(), Class7.smethod_0(this.Lbl_CreditAmt.Text), false);
                            new Class6().method_12("A");
                        }
                    }
                    Class6.string_5 = this.ddvqeXfa4.Text.Trim();
        ...
        private void timer_0_Tick(object sender, EventArgs e)
        {
            try
            {
                double num = (Class7.smethod_0(this.Txt_DbAmt3.Text) + Class7.smethod_0(this.Txt_DbAmt2.Text)) + Class7.smethod_0(this.Txt_DbAmt1.Text);
        ...
        private void Txt_DbAccId1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F5)
            {
                ...
                this.string_1 = "SELECT account_id AS [Số TK], abbreviat AS [T\x00ean viết tắt], mof_gl AS [Cấp 3], name AS [T\x00ean đầy đủ] FROM tblAccount where status = 1 and account_id LIKE '" + str + "%'";
                Class7.smethod_16(this.string_1, this.oleDbConnection_0);
                this.Txt_DbAccId1.Text = FrmBrowse.strReturn;
            }
        }
        ...
        private void Txt_DbAccId2_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F5)
            {
                ...
                this.string_1 = "SELECT account_id AS [Số TK], abbreviat AS [T\x00ean viết tắt], mof_gl AS [Cấp 3], name AS [T\x00ean đầy đủ] FROM tblAccount where status = 1 and account_id LIKE '" + str + "%'";
                Class7.smethod_16(this.string_1, this.oleDbConnection_0);
                this.Txt_DbAccId2.Text = FrmBrowse.strReturn;
            }
        }
        ...
        private void Txt_DbAccId3_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F5)
            {
                ...
                this.string_1 = "SELECT account_id AS [Số TK], abbreviat AS [T\x00ean viết tắt], mof_gl AS [Cấp 3], name AS [T\x00ean đầy đủ] FROM tblAccount where status = 1 and account_id LIKE '" + str + "%'";
                Class7.smethod_16(this.string_1, this.oleDbConnection_0);
                this.Txt_DbAccId3.Text = FrmBrowse.strReturn;
            }
        }
